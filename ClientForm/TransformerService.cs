...
public partial class TransformerService {
  public interface ISync {
    ...
    void logout(string username, string password, string host, int port);
  ...
  public interface Iface : ISync {
    #if SILVERLIGHT
    IAsyncResult Begin_transform(AsyncCallback callback, object state, string text);
    string End_transform(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
    ...
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_logout(AsyncCallback callback, object state, string username, string password, string host, int port);
  ...
  public class Client : IDisposable, Iface {
    ...
    public IAsyncResult Begin_transform(AsyncCallback callback, object state, string text)
    {
      return send_transform(callback, state, text);
    }

    public string End_transform(IAsyncResult asyncResult)
    {
    ...
    {
      #if SILVERLIGHT
      var asyncResult = Begin_transform(null, null, text);
      return End_transform(asyncResult);
    ...
    #if SILVERLIGHT
    public IAsyncResult send_transform(AsyncCallback callback, object state, string text)
    {
      oprot_.WriteMessageBegin(new TMessage("transform", TMessageType.Call, seqid_));
    ...
    public void send_transform(string text)
    {
      oprot_.WriteMessageBegin(new TMessage("transform", TMessageType.Call, seqid_));
      transform_args args = new transform_args();
      args.Text = text;
    ...
    public string recv_transform()
    {
      ...
      throw new TApplicationException(TApplicationException.ExceptionType.MissingResult, "transform failed: unknown result");
    }
    ...
    public IAsyncResult Begin_logout(AsyncCallback callback, object state, string username, string password, string host, int port)
    {
      return send_logout(callback, state, username, password, host, port);
    }
    ...
    public void logout(string username, string password, string host, int port)
    {
      #if SILVERLIGHT
      var asyncResult = Begin_logout(null, null, username, password, host, port);
      End_logout(asyncResult);

      #else
      send_logout(username, password, host, port);
      recv_logout();

      #endif
    }
    #if SILVERLIGHT
    public IAsyncResult send_logout(AsyncCallback callback, object state, string username, string password, string host, int port)
    {
    ...
    public void send_logout(string username, string password, string host, int port)
    {
      oprot_.WriteMessageBegin(new TMessage("logout", TMessageType.Call, seqid_));
      logout_args args = new logout_args();
      args.Username = username;
  ...
  public class Processor : TProcessor {
    ...
    {
      iface_ = iface;
      processMap_["transform"] = transform_Process;
    ...
    public void transform_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      transform_args args = new transform_args();
      args.Read(iprot);
      iprot.ReadMessageEnd();
      ...
      try
      {
        result.Success = iface_.transform(args.Text);
    ...
    public void logout_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      try
      {
        iface_.logout(args.Username, args.Password, args.Host, args.Port);
  ...
  [Serializable]
  #endif
  public partial class transform_args : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("transform_args");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("transform_args(");
      bool __first = true;
      if (Text != null && __isset.text) {
  ...
  [Serializable]
  #endif
  public partial class transform_result : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("transform_result");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("transform_result(");
      bool __first = true;
